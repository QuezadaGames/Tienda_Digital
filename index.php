    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Tu Estilo</a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">Blvd. Miguel Hidalgo y Costilla y Cto. Gral. Felipe Ángeles Ramírez
Fracc. Los Héroes Tizayuca, Tizayuca </p>
            </div>
        </div>
    </header>
    <section class="py-5">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Anel Alejandra Lima Orozco</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
